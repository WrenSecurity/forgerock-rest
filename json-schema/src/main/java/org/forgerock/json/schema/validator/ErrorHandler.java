 ...
 *
 * <p>If a Validator application needs to implementation of customized error
 * handling, it must implement this class.
 *
 * <p>Use this handler when call the
...
public abstract class ErrorHandler {
     ...
     *
     * <p>None of the implementations of {Validator#validate} method throws exception. They call
     ...
     *
     * <p>The default value is <code>false</code>. If the validator has called the {#handleError}
     * method then it return <code>true</code>.
     *
     ...
     *
     * <p>Implementation of this method MUST throw an Exception if the {#error()} method
